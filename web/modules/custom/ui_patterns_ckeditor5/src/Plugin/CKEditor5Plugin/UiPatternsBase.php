...
/**
 * UI Patterns base plugin class.
 */
abstract class UiPatternsBase extends CKEditor5PluginDefault implements CKEditor5PluginConfigurableInterface, CKEditor5PluginElementsSubsetInterface, ContainerFactoryPluginInterface {
   ...
   */
  public const MULTIPLE_GROUPS_KEY = 'ui_patterns_multiple_groups';
  ...
  public function __construct(
    ...
    UiPatternsManagerInterface $patternsManager,
...
//            dd($form['enabled_styles'][$group_key]);
          }
          // @phpstan-ignore-next-line
          $form['enabled_patterns'][$group_key]['#open'] = $opened_group;

          $form['enabled_patterns'][$group_key][$style_plugin_id] = $plugin_element;
//          dd($plugin_element);
        }
        else {
          $form['enabled_patterns'][$style_plugin_id] = $plugin_element;
        }
      }
    }
  ...
  public function validateConfigurationForm(array &$form, FormStateInterface $form_state): void {
    ...
    $form_value = $form_state->getValue('enabled_patterns');
    ...
    $form_state->setValue('enabled_patterns', $config_value);
  }
  ...
  public function submitConfigurationForm(array &$form, FormStateInterface $form_state): void {
    $this->configuration['enabled_patterns'] = $form_state->getValue('enabled_patterns');
  }
